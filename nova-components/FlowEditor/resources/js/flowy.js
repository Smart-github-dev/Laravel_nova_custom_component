    ...
    flowy.load = function () {
        try {
            ...
            flowy.beginDrag = function (event) {
                if (
                    window.getComputedStyle(canvas_div).position ==
                        "absolute" ||
                    window.getComputedStyle(canvas_div).position == "fixed"
                ) {
                    absx = canvas_div.getBoundingClientRect().left;
            ...
            function checkAttach(id) {
                ...
                if (
                    xpos >= block.x - block.width / 2 - paddingx - 40 &&
                    xpos <= block.x + block.width / 2 + paddingx + 40 &&
                    ypos >= block.y - (block.height - 40) / 2 &&
                    ypos <= block.y + block.height + 40
                ) {
                    return true;
                } else {
                    return false;
            ...
            function snap(drag, i, blocko) {
                ...
                for (
                    ...
                    var children = blocks.filter(
                        (id) => id.parent == blocko[i]
                    )[w];
                    ...
                    for (var w = 0; w < blockstemp.length; w++) {
                        if (
                            ...
                            blockstemp[w].x =
                                ...
                                window.scrollX +
                                parseInt(
                                    window.getComputedStyle(blockParent).width
                                ) /
                                    2 +
                                canvas_div.scrollLeft -
                                canvas_div.getBoundingClientRect().left;
                            blockstemp[w].y =
                                ...
                                window.scrollY +
                                parseInt(
                                    window.getComputedStyle(blockParent).height
                                ) /
                                    2 +
                                canvas_div.scrollTop -
                                canvas_div.getBoundingClientRect().top;
                ...
                var arrowblock = blocks.filter(
                    (a) =>
                        a.id == parseInt(drag.querySelector(".blockid").value)
                )[0];
                var arrowx =
                    arrowblock.x -
                    blocks.filter((a) => a.id == blocko[i])[0].x +
                ...
                if (blocks.filter((a) => a.id == blocko[i])[0].parent != -1) {
                    ...
                    while (!flag) {
                        if (
                            blocks.filter((a) => a.id == idval)[0].parent == -1
                        ) {
                            flag = true;
                        } else {
                            var zwidth = 0;
                            for (
                                var w = 0;
                                w <
                                blocks.filter((id) => id.parent == idval)
                                    .length;
                                w++
                            ) {
                                var children = blocks.filter(
                            ...
                            blocks.filter((a) => a.id == idval)[0].childwidth =
                                zwidth;
                            idval = blocks.filter((a) => a.id == idval)[0]
                                .parent;
                        }
                    }
                    blocks.filter((id) => id.id == idval)[0].childwidth =
                        totalwidth;
                }
                if (rearrange) {
                    rearrange = false;
            ...
            flowy.moveBlock = function (event) {
                ...
                if (dragblock) {
                    ...
                    while (!flag) {
                        ...
                        if (foundids.length == 0) {
                            ...
                            layer = blocks.filter((a) =>
                                foundids.includes(a.parent)
                            );
                            foundids = [];
                        }
                    }
                ...
                if (active || rearrange) {
                    if (
                        ...
                        mouse_x <
                            canvas_div.getBoundingClientRect().left + 10 &&
                ...
                if (
                    ...
                    for (var w = 0; w < blocks.length; w++) {
                        document.querySelector(
                            ...
                            blocks.filter((a) => a.id == blocko[w])[0].width /
                                2 -
                            offsetleft +
                            canvas_div.getBoundingClientRect().left -
                            absx +
                            ...
                            "px";
                        if (
                            blocks.filter((a) => a.id == blocko[w])[0].parent !=
                            -1
                        ) {
                            var arrowblock = blocks.filter(
                                (a) => a.id == blocko[w]
            ...
            function rearrangeMe() {
                ...
                for (var z = 0; z < result.length; z++) {
                    ...
                    for (
                        var w = 0;
                        w <
                        blocks.filter((id) => id.parent == result[z]).length;
                        w++
                    ) {
                        var children = blocks.filter(
                            (id) => id.parent == result[z]
                        )[w];
                        if (
                            blocks.filter((id) => id.parent == children.id)
                                .length == 0
                        ) {
                        ...
                        if (children.childwidth > children.width) {
                            if (
                                w ==
                                blocks.filter((id) => id.parent == result[z])
                                    .length -
                                    1
                            ) {
                    ...
                    if (result[z] != -1) {
                        blocks.filter((a) => a.id == result[z])[0].childwidth =
                            totalwidth;
                    }
                    for (
                        var w = 0;
